...
class User extends Authenticatable implements TableInterface, JWTSubject
{
    ...
    /**
     * Get the identifier that will be stored in the subject claim of the JWTProvider.
     *
     * @return mixed
     */
    ...
    /**
     * Return a key value array, containing any custom claims to be added to the JWTProvider.
     *
     * @return array
     */
